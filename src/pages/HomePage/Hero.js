        ...
        <div className="flex md:flex-row lg:flex-row mx-10 md:mx-32 lg:mx-32 lg:mt-24">
          <div className="flex flex-col lg:w-3/5 items-stretch pt-0 md:pt-10 lg:pt-10 pb-16 md:pb-32 lg:pb-32">
            <MotionInView variants={varFadeInLeft}>
              <h1 className="font-medium text-transparent bg-clip-text header-gradent mt-5 md:mt-0 mr-0 lg:mr-44 lg:mt-0 text-2xl md:text-4xl lg:text-[62px] ">
                Reimagining NFT management through the raw power of the blockchain
              </h1>
            </MotionInView>
            ...
            <MotionInView variants={varFadeInUp}>
              <a href="/assets/pdf/VAULT3D-Whitepaper.pdf" target="_blank">
                <button className="px-6 py-2 mt-14 text-3xl bg-white bg-steel-button bg-cover bg-center text-black font-bold uppercase focus:shadow-outline hover:bg-indigo-600 hover:text-themePrimaryDark-100">
                  Start Collect
                </button>
              </a>
            </MotionInView>
